...
export default function About() {
    return (
        <div className="min-h-screen bg-black text-white">
            ...
            {/* Full-height top cover so no gap shows behind the navbar */}
            <div className="pt-32 pb-20">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="mb-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="aspect-square bg-white/5 border border-white/20 flex items-center justify-center">
                            <img src={aboutData.image} alt={aboutData.imageTitle}/>
                        </div>
                        <div>
                            <h2
                    ...
                    <section className="mb-20 border-t border-white/10 pt-20">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="border border-white/20 hover:border-[#FF2E63] transition-colors p-8">
                                <div className="aspect-square bg-white/5 mb-6 flex items-center justify-center">
                                    <img src={aboutData.carPhoto} alt="Car Photo"/>
                                </div>
                                <h3 className="text-2xl font-black mb-3" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>CARS</h3>
                            ...
                            <div className="border border-white/20 hover:border-[#00E5FF] transition-colors p-8">
                                <div className="aspect-square bg-white/5 mb-6 flex items-center justify-center">
                                    <img src={aboutData.streamPhoto} alt="Gaming/Esports"/>
                                </div>
                                <h3 className="text-2xl font-black mb-3" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>GAMING & ESPORTS</h3>
                                <p className="text-sm text-gray-400 leading-relaxed">
                            ...
                            <div className="border border-white/20 hover:border-[#CCFF00] transition-colors p-8">
                                <div className="aspect-square bg-white/5 mb-6 flex items-center justify-center">
                                    <img src={aboutData.filmPhoto} alt="Film"/>
                                </div>
                                <h3 className="text-2xl font-black mb-3" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>FILMMAKING</h3>
                                <p className="text-sm text-gray-400 leading-relaxed">
                                    Although not talented behind a camera, I still love picking it up and taking candid photos and videos of my surroundings.
                                </p>
                            </div>

                            <div className="border border-white/20 hover:border-[#FF2E63] transition-colors p-8">
                                <div className="aspect-square bg-white/5 mb-6 flex items-center justify-center">
                                    <img src={aboutData.gymPhoto} alt="Fitness"/>
                                </div>
                                <h3 className="text-2xl font-black mb-3" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>FITNESS</h3>
                                <p className="text-sm text-gray-400 leading-relaxed">
                            ...
                            <div className="border border-white/20 hover:border-[#00E5FF] transition-colors p-8">
                                <div className="aspect-square bg-white/5 mb-6 flex items-center justify-center">
                                    <img src={aboutData.electricalPhoto} alt="Electrical Hardware"/>
                                </div>
                                <h3 className="text-2xl font-black mb-3" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>HARDWARE</h3>
                                <p className="text-sm text-gray-400 leading-relaxed">
                            ...
                            <div className="border border-white/20 hover:border-[#CCFF00] transition-colors p-8">
                                <div className="aspect-square bg-white/5 mb-6 flex items-center justify-center">
                                    <img src={aboutData.setupPhoto} alt="Content Creation"/>
                                </div>
                                <h3 className="text-2xl font-black mb-3" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>CONTENT</h3>
                                <p className="text-sm text-gray-400 leading-relaxed">
